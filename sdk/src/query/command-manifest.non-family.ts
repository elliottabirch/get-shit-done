...
export const NON_FAMILY_COMMAND_MANIFEST: readonly NonFamilyCommandManifestEntry[] = [
  ...
  { canonical: 'codebase.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'codebase.get', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'codebase.list', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'report.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'report.get', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'handoff.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'continue-here.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'forensics.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'decisions-index.get', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'debug.archive', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'spike.get-manifest', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'spike.get-conventions', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'spike.put-wrap-up', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'spike.put-conventions', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'sketch.get-manifest', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'sketch.get-conventions', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'sketch.put-wrap-up', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'thread.add', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'seed.add', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'todo.add', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'milestone.archive-phases', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'phase.get-manifest', aliases: [], mutation: false, outputMode: 'json' },
  { canonical: 'graphify.store', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'tmp.put', aliases: [], mutation: true, outputMode: 'json' },
  { canonical: 'tmp.get', aliases: [], mutation: false, outputMode: 'json' },
] as const;
