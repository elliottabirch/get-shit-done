...
- [x] 02-02-PLAN.md — Phase / state / progress / roadmap reads (8 SDK handlers — phase, roadmap, progress reads, audit-open, phase-ready, verify reads, check-verification-status, detect-phase-type)
